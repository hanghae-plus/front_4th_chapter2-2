...
export default [
  ...
  sonarjs.configs.recommended,
  {
    ...
    settings: {                                       // 모든 규칙에 사용할 수 있는 정보의 key-value 쌍이 포함된 객체
      react: {
        version: 'detect',
      },
    },
    rules: {                                          // 구성된 규칙이 포함된 객체, files가 지정되면 포함된 파일만 검사
      // Prettier 통합 규칙
