...
interface ICartCouponsListProps {
  coupons: Coupon[];
  cart: CartItem[];
...
export const CartCouponsList = ({ coupons, cart, removeFromCart, updateQuantity, applyCoupon, calculateTotal, selectedCoupon }: ICartCouponsListProps) => {
